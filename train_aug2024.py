...
if __name__=='__main__':
    ...
    parser.add_argument('--train_set', type=str, default='train_augment100x_20aug2024', help='training set (must exist in RelaxDB/split_files)')
    parser.add_argument('--valid_set', type=str, default='val_20aug2024', help='validation set (must exist in RelaxDB/split_files)')
